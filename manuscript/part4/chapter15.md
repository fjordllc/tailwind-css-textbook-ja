...
<figure>
<img src="../figures/fig-15-1.svg" alt="flex-row と flex-col で、justify-* が主軸、items-* が交差軸に効くことを示した図。">
<figcaption>図 15-1　`justify-*` は主軸、`items-*` は交差軸に効く。主軸の向きは `flex-row` / `flex-col` で変わる。</figcaption>
</figure>
