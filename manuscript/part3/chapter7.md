...
<figure>
<img src="../figures/fig-7-1.svg" alt="Tailwind CSS の導入経路を、学習用の Play CDN、本番向けの Vite プラグイン、PostCSS、Rails gem、CLI に分けて選ぶ流れを示す図。">
<figcaption>図 7-1　Tailwind の導入経路は、目的とビルド主体で選ぶ。</figcaption>
</figure>
