...
<figure>
<img src="../figures/fig-24-1.svg" alt="Rails のビューを partial から ViewComponent、必要に応じて Phlex や Ruby のバリアントビルダーへ段階的に育てる流れを示す図。">
<figcaption>図 24-1　Rails のコンポーネント化は、partial から始めて必要に応じて育てる。</figcaption>
</figure>
