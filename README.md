...
📝 **執筆フェーズ。第1〜5部を執筆済み。第5部の品質レビュー待ち。**
...
6. ✅ 第5部（第17〜21章）を執筆（`manuscript/part5.md`）
7. ⏳ 第5部の品質レビュー（レスポンシブ/ダークモード/アニメ/フォーム/a11y の正確さ）← **いまここ**
8. ⬜ 以降、第6部から順に執筆 → 各部レビュー → 最終レビュー
...
| `manuscript/part6.md`〜`part8.md`, `appendix.md` | 残りの本文。**部ごとに 1 ファイル**。 | ⬜ これから |
