...
📝 **全31章＋付録の初稿が完成。第8部・付録の品質レビューと、全体の最終レビュー待ち。**
...
4. ✅ 第3部（第7〜9章）を執筆・品質レビュー反映済み（`manuscript/part3.md`）
5. ✅ 第4部（第10〜16章）を執筆・品質レビュー反映済み（`manuscript/part4.md`）
6. ✅ 第5部（第17〜21章）を執筆・品質レビュー反映済み（`manuscript/part5.md`）
7. ✅ 第6部（第22〜25章）を執筆・品質レビュー反映済み（`manuscript/part6.md`）
8. ✅ 第7部（第26〜28章）を執筆・品質レビュー反映済み（`manuscript/part7.md`）
9. ✅ 第8部（第29〜31章）・付録を執筆（`manuscript/part8.md`, `appendix.md`）
10. ⏳ 第8部・付録の品質レビュー → 全体の最終レビュー（重複/章間の流れ/用語揺れ/リンク切れ/完成度）← **いまここ**
...
| `manuscript/appendix.md` | 付録A〜E（docs の歩き方／よく使う Utility／チートシート／用語集／AI プロンプト集）。 | ✅ 執筆済み |
