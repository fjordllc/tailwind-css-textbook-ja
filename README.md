...
📝 **執筆フェーズ。第1〜2部を執筆済み。第2部の品質レビュー待ち。**

進め方は次のとおりです。

1. ✅ 全31章＋付録の詳細な目次（`OUTLINE.md`）と執筆ルール（`STYLEGUIDE.md`）を作成・構成レビュー反映済み
2. ✅ 第1部（第1〜3章）を執筆・品質レビュー反映済み（`manuscript/part1.md`）
3. ✅ 第2部（第4〜6章）を執筆（`manuscript/part2.md`）
4. ⏳ 第2部の品質レビュー（v4 説明の正確さ・「なぜ」・参考資料）← **いまここ**
5. ⬜ 以降、第3部から順に執筆 → 各部レビュー → 最終レビュー
...
| `manuscript/part3.md`〜`part8.md`, `appendix.md` | 残りの本文。**部ごとに 1 ファイル**。 | ⬜ これから |
