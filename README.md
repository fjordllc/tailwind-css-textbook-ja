...
📝 **執筆フェーズ。第1〜4部を執筆済み。第4部の品質レビュー待ち。**
...
5. ✅ 第4部（第10〜16章）を執筆（`manuscript/part4.md`）
6. ⏳ 第4部の品質レビュー（クラス名・出力 CSS の正確さ・リファレンス化していないか）← **いまここ**
7. ⬜ 以降、第5部から順に執筆 → 各部レビュー → 最終レビュー
...
| `manuscript/part5.md`〜`part8.md`, `appendix.md` | 残りの本文。**部ごとに 1 ファイル**。 | ⬜ これから |
