...
📝 **執筆フェーズ。第1部（第1〜3章）を執筆済み。品質レビュー待ち。**

進め方は次のとおりです。

1. ✅ 全31章＋付録の詳細な目次（`OUTLINE.md`）と執筆ルール（`STYLEGUIDE.md`）を作成・構成レビュー反映済み
2. ✅ 第1部（第1〜3章）を執筆（`manuscript/part1.md`）
3. ⏳ 第1部の品質レビュー（文体・難易度・「なぜ」の説明・参考資料の使い方）← **いまここ**
4. ⬜ 以降、第2部から順に執筆 → 各部レビュー → 最終レビュー
...
| `manuscript/part2.md`〜`part8.md`, `appendix.md` | 残りの本文。**部ごとに 1 ファイル**。 | ⬜ これから |
