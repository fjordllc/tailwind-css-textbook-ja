...
📝 **設計フェーズ（目次・執筆ルールの確定中）。本文はこれから執筆します。**

進め方は次の3ステップで、いまは 1 が完了し 2 のレビュー待ちです。

1. ✅ 全31章＋付録の詳細な目次（`OUTLINE.md`）と執筆ルール（`STYLEGUIDE.md`）を作成
2. ⏳ 目次・ルールをレビューして確定 ← **いまここ**
3. ⬜ 確定後、第1部から順に本文（`manuscript/`）を執筆
...
| `manuscript/` | 本文の原稿。**部ごとに 1 ファイル**（`part1.md`〜`part8.md`、`appendix.md`）。 | ⬜ これから |
